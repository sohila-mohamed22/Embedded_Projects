...
void LCD_vInit(void)
{
	...
	DIO_vset_pin_dir('C',EN,1);
	DIO_vset_pin_dir('C',RS,1);
	DIO_vset_pin_dir('C',RW,1);
	DIO_vwrite_pin('C',RW,0);
...
{
	DIO_vwrite_pin('C',EN,1);
	_delay_ms(2);
	DIO_vwrite_pin('C',EN,0);
	_delay_ms(2);
}
